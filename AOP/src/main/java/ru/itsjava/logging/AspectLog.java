...
public class AspectLog {
        @Before("execution (* ru.itsjava.dao.DaoCoffee.getCoffeeById(..))")
        public void logBefore(JoinPoint joinPoint){
//        System.out.println(joinPoint.getTarget().getClass().getName());
            System.out.println("Log before " + joinPoint.getSignature().getName());
        }
        @After("execution (* ru.itsjava.dao.DaoCoffee.getCoffeeById(..))")
        public void logAfter(JoinPoint joinPoint){
            System.out.println("Log after " + joinPoint.getSignature().getName());
        }

        @Around("execution (* ru.itsjava.service.ServiceCoffee.*(..))")
